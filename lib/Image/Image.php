...
class Image{
    ...
    // 字体
    const FONT_MSYHBD = 'fonts/msyhbd.ttf';
    const FONT_SIMHEI = 'fonts/simhei.ttf';
    const FONT_SIMKAI = 'fonts/simkai.ttf';
    ...
    public function text($text, $font, $size, $color = '#00000000', 
        ...
        $this->img->text($text, __DIR__.'/'.$font, $size, $color, $locate, $offset, $angle);
        return $this;
    }
}